...
class CalendarDelegate: NSObject, JTACMonthViewDelegate, JTACMonthViewDataSource {
    ...
    func calendar(
        ...
        let cell =
            calendar.dequeueReusableJTAppleCell(withReuseIdentifier: DateCell.reuseID, for: indexPath) as! DateCell
    ...
    func calendar(
        _ calendar: JTACMonthView, willDisplay cell: JTACDayCell, forItemAt date: Date, cellState: CellState,
        indexPath: IndexPath
    ) {
    ...
    func calendar(
        _ calendar: JTACMonthView, headerViewForDateRange range: (start: Date, end: Date), at indexPath: IndexPath
    ) -> JTACMonthReusableView {
        formatter.dateFormat = "yyyy.MM"

        let header =
            calendar.dequeueReusableJTAppleSupplementaryView(withReuseIdentifier: DateHeader.reuseID, for: indexPath)
            as! DateHeader
...
struct CalendarView: UIViewRepresentable {
    ...
    func makeUIView(context: UIViewRepresentableContext<CalendarView>) -> UIView {
        ...
        calendar.register(
            DateHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader,
