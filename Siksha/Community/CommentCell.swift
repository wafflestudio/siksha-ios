...
struct CommentCell_preview:PreviewProvider{
    static var previews: some View{
       CommentList(comments: [
        Comment(userName: "username", content: "w: 305 본문 본문2", createdAt: "23/09/27", likeCount: 2, isLiked: false),
        Comment(userName: "username", content: "본문 본문 본문 본문 본문 본문본문 본문 본문 본문 본문 본문본문 본문 본문 본문 본문 본문", createdAt: "23/09/27", likeCount: 2, isLiked: false),
        Comment(userName: "username", content: "본문 본문3", createdAt: "23/09/27", likeCount: 2, isLiked: false),
       ])
    }
}
